...
const web3 = new Web3('ws://127.0.0.1:7545') // websocket connection to your alchemy node to monitor mainnet
...
const AMOUNT = '0.25' // WETH to spend on new tokens
...
const main = async () => {
    ...
    uFactory.events.PairCreated({}, async (error, event) => {
        ...
        const token = new web3.eth.Contract(IERC20.abi, path[1])
